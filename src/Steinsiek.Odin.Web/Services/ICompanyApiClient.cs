...
public interface ICompanyApiClient
{
    ...
    /// <summary>
    /// Retrieves a paged, filtered, and sorted list of companies.
    /// </summary>
    ...
    Task<PagedResult<CompanyDto>?> GetPaged(int page, int pageSize, string? sort, SortDirection? sortDir, string? search, CompanyFilterQuery? filter, CancellationToken cancellationToken);
